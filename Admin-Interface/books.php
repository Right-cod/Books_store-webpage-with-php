...
<div class="text-center">
	 ...
	 <form action="template/BookinsertQuery.php" id="add_book" method="POST" enctype="multipart/form-data"> 
  ...
  <div class="form-row" >
	...
	<div class="form-group col-md-4">
      <label >Author</label>
	  <select id="" class="form-control" name="author"  required>
		  <option value="">Select Author</option>
		  <?php
$ak=mysqli_query($conn,"SELECT * FROM author");
while($gh=mysqli_fetch_array($ak)){
	?>
<option value="<?php echo $gh['fname']." ".$gh['lname'] ?>"><?php echo $gh['fname']." ".$gh['lname'] ?></option>
	<?php
}
		  ?>
	  </select>
